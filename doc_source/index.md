...
+ [Sources for AWS SCT](CHAP_Source.md)
   ...
   + [Using Apache Hadoop as a source for AWS SCT](CHAP_Source.Hadoop.md)
   + [Using Apache Oozie as a source for AWS SCT](CHAP_Source.Oozie.md)
...
+ [Migrating big data frameworks with AWS Schema Conversion Tool](CHAP-migrating-big-data.md)
...
+ [AWS SCT CLI Reference](CHAP_Reference.md)
