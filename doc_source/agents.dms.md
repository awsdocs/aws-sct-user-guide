...
#### Step 6: Creating a local & AWS DMS task<a name="agents.dms.Snowball.SBS.CreateLocalRemoteTask"></a>
...
#### Step 7: Running and monitoring the AWS SCT task<a name="agents.dms.Snowball.SBS.RunMonitorLocalTask"></a>
