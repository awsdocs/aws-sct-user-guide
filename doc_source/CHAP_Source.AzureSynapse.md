...
## Privileges for Azure Synapse Analytics as a source database<a name="CHAP_Source.AzureSynapse.Permissions"></a>
...
## Azure Synapse Analytics to Amazon Redshift conversion settings<a name="CHAP_Source.AzureSynapse.ConversionSettings"></a>
...
## Azure Synapse Analytics to Amazon Redshift conversion optimization settings<a name="CHAP_Source.AzureSynapse.ConversionOptimizationSettings"></a>
