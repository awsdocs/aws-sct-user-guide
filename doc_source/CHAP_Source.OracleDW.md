...
## Oracle Data Warehouse to Amazon Redshift conversion settings<a name="CHAP_Source.OracleDW.ConversionSettings"></a>
...
+ To emulate the behavior of primary and unique keys in your Amazon Redshift cluster, select **Automate Primary key / Unique constraint**\.
...
## Oracle Data Warehouse to Amazon Redshift conversion optimization settings<a name="CHAP_Source.OracleDW.ConversionOptimizationSettings"></a>
